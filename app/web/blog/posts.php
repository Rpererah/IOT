      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-heading">
            <h1>Automatização das lampadas</h1>
            <h2 class="subheading">...</h2>
            <span class="meta">Postado por
              <a href="#">(nome da pessoa que postou)</a>
              (DATA)</span>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <blockquote class="blockquote"> (texto claro).</blockquote>
          ...
          <span class="caption text-muted">(TITULO)</span>
